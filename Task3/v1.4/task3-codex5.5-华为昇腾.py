...
Optimized for Huawei Ascend NPU compatibility with conservative Triton patterns.
"""
...
def _silu_grad_quant_kernel(
    ...
    inv_scale_gate = 1.0 / scale_gate
    inv_scale_up = 1.0 / scale_up

    q_gate_f = d_gate * inv_scale_gate[:, None]
    q_up_f = d_up * inv_scale_up[:, None]
...
def silu_dot_fwd_bwd_quant_fuse(
    ...
    grad_grid = (M // GRAD_BLOCK_M, h_groups)
