...
def silu_dot_fwd_bwd_quant_fuse(
    ...
    """
    Fused SwiGLU backward recompute plus INT8 quantization.

    The implementation uses Triton only for the numerical path.  Gradients are
    quantized per row and per 128-channel group, while y.T is quantized per
    channel and per 128-token group.
    """
